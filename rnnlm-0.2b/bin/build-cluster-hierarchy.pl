...
my $RNNLM_KMEANS_N_CORES = `nproc`; #由运行服务器的CPU核心决定，比如32
chomp $RNNLM_KMEANS_N_CORES;
my $HERE = `dirname $0`; #perl脚本绝对路径
chomp $HERE;
...
sub compute_cluster 
{
	my $s = shift; #cluster size
	my $f = shift; #trace file
